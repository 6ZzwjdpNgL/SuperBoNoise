function state_player_cheesepepstick() //state_player_cheesepepstick
{
    hsp = 0
    vsp = 0
...
function state_player_cheesepepstickside() //state_player_cheesepepstickside
{
...
function state_player_cheesepepstickup() //state_player_cheesepepstickup
{
