function state_player_bombgrab() //state_player_bombgrab
{
...
function state_player_bombpepup() //state_player_bombpepup
{
    image_speed = 0.35
    vsp = bombup_dir * 11
    hsp = 0
...
function state_player_bombpepside() //state_player_bombpepside
{
...
function state_player_bombpep() //state_player_bombpep
{
    alarm[8] = 60
    alarm[7] = 120
    hurted = 1
    ...
    if (floor(image_index) != 0 && floor(image_index) != 2)
        steppy = 0
    if (input_check_pressed("slap") && state != (2 << 0) && sprite_index != spr_bombpepintro && sprite_index != spr_bombpepend)
    {
        sprite_index = spr_null
        image_index = 0
        hsp = 0
