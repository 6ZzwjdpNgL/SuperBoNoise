function event_play_oneshot(argument0, argument1, argument2, argument3) //event_play_oneshot
{
...
{
    return fmod_event_getPlaybackState(argument0) == (0 << 0);
}

function event_play_multiple(argument0, argument1, argument2, argument3) //event_play_multiple
{
    if (argument1 == undefined)
        argument1 = undefined
    if (argument2 == undefined)
...
function event_quick3D(argument0, argument1, argument2, argument3) //event_quick3D
{
    if (argument1 == undefined)
        argument1 = x
    if (argument2 == undefined)
...
function kill_sounds(argument0) //kill_sounds
{
...
function kill_sound_list(argument0) //kill_sound_list
{
...
function fmod_create_ext(argument0) //fmod_create_ext
{
...
function set_option_params() //set_option_params
{
...
function add_music(argument0, argument1, argument2, argument3) //add_music
{
    if (argument2 == undefined)
        argument2 = undefined
    if (argument3 == undefined)
...
function stop_music(argument0) //stop_music
{
...
function wrap_music(argument0, argument1) //wrap_music
{
