...
add_music(rm_mainmenu, "event:/music/Title", undefined, function(argument0, argument1) //anon@899@gml_Object_obj_music_Create_0
{
    fmod_event_setParameter(argument1, "state", 0, true)
}
)
add_music(rank_room, "event:/music/pillarmusic", undefined, undefined)
add_music(creditsroom, "event:/music/credits", undefined, function(argument0, argument1) //anon@1111@gml_Object_obj_music_Create_0
{
...
add_music(water_1, "event:/music/water", "event:/music/water_secret", function(argument0, argument1) //anon@1423@gml_Object_obj_music_Create_0
{
    var s = -1
...
add_music(rm_levelselect, "event:/music/Title", "event:/music/secret_default", function(argument0, argument1) //anon@2455@gml_Object_obj_music_Create_0
{
