...
{
    if (baddieID.thrown != 1 && (!other.baddieID.mach3destroy) && baddieID.state != (139 << 0) && other.baddieID.thrown == true && other.baddieID.state != (139 << 0) && baddieID.killbyenemy && baddieID != other.id && baddieID.state != (6 << 0) && (!baddieID.invincible) && baddieID.instantkillable && ((global.attackstyle != 2 && (!global.kungfu)) || baddieID.hp <= 0) && (!global.kungfu))
    {
