...
if (optionselected == 0)
{
    ...
    if (input_check_pressed("jump") || keyboard_check_pressed(vk_return))
    {
...
if (optionselected == 2)
{
    ...
    {
        if (input_check_pressed("jump") || keyboard_check_pressed(vk_return) || keyboard_check_pressed(vk_return))
        {
            stopInputs = true
