    ...
    case (2 << 0):
        ...
        if (!_transfo)
        {
            with (_player)
            {
                ...
                else if (s == (123 << 0) || sprite_index == spr_mach3boost)
                    tv_do_expression(spr_tv_exprmach3)
                else if (s == (109 << 0) || state == (273 << 0))
    ...
    case (253 << 0):
        ...
        switch expressionsprite
        {
            ...
            case spr_tv_exprcombo:
                if (global.combo < 3 || _player.isgustavo || _player.mach4mode || _player.state == (109 << 0) || _player.state == (123 << 0) || _player.sprite_index == _player.spr_mach3boost || global.stylethreshold >= 3)
                {
                    state = (252 << 0)
                    expressionsprite = -4
                    if (_player.state == (109 << 0) || _player.state == (273 << 0))
                        tv_do_expression(spr_tv_exprhurt)
                }
                break
            ...
            case spr_tv_exprmach3:
                with (obj_player1)
                {
                    if (state != (123 << 0) && state != (39 << 0) && (state != (63 << 0) || (tauntstoredstate != (123 << 0) && tauntstoredstate != (39 << 0))) && sprite_index != spr_mach3boost && mach4mode == 0)
                    {
                        other.state = (252 << 0)
            ...
            case spr_tv_exprmach4:
                with (obj_player1)
                {
                    if (mach4mode == 0 && (state != (63 << 0) || (tauntstoredstate != (123 << 0) && tauntstoredstate != (39 << 0))))
                    {
                        other.state = (252 << 0)
                        other.expressionsprite = -4
                    }
            ...
            case spr_tv_exprheat:
                ...
                if (global.stylethreshold < 3 || _transfo || _player.mach4mode || _player.state == (109 << 0) || _player.state == (123 << 0) || _player.sprite_index == _player.spr_mach3boost)
                {
                    state = (252 << 0)
                    expressionsprite = -4
                }
            ...
            case spr_tv_exprpanic:
                ...
                if ((!global.panic) || _transfo || _player.mach4mode || _player.state == (109 << 0) || _player.state == (123 << 0) || _player.sprite_index == _player.spr_mach3boost)
                {
                    state = (252 << 0)
                    expressionsprite = -4
                }
